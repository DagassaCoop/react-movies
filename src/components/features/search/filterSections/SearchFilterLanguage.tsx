...
const SearchFilterLanguage: React.FC = () => {
  ...
  const stateLanguage = useAppSelector(state => state.filters.filtersViewStructure[EFilterSection.language].language)
  ...
  return (
    <div className="search-filter search-filter_language">
      ...
      <RBS.Form.Select className="search-filter__select" onChange={onChangeHandler} value={language.data.iso_639_1}>
